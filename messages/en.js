...
exports.trans = {
	...
	home_wanna_website: 'Need a website?',
	...
	about_us_1:
		'<p>\
			...
			<li>Мы предосталяем бесплатные консультации.\
		</p>',
		// ABOUT US
	about_us_1:
		'<p>\
			...
			<li>Нам не важна география, Вы можете находиться где угодно, чтобы отбратиться к нам за помощью.</li>\
	...
	',
	services_2_title: 'Home page',
	services_2_text: '\
		<li>Lorem ipsum dolor sit amet,</li>\
		<li>consectetur adipiscing elit.</li>\
		<li>Vivamus at augue imperdiet</li>\
	',
	services_3_title: 'Webstore',
	services_3_text: '\
		<li>Lorem ipsum dolor sit amet,</li>\
		<li>consectetur adipiscing elit.</li>\
		<li>Vivamus at augue imperdiet</li>\
	...
	// footer
	all_rights_reserved: 'All rights reserved © Aliselab 2018',
};
